...
import { Text, View, ScrollView, ActivityIndicator, StyleSheet, StatusBar } from 'react-native'
            ...
            <ScrollView style={styles.container}>
                ...
                <View style={styles.mountArea}>
                    <View style={styles.incomeArea1}>
                        <Text style={{ color: '#cfbfe0', fontSize: 20, fontWeight: 'bold' }}>Today's Income</Text>
                        <Text style={{ color: '#ccc', marginTop: 10, fontSize: 18 }}>Rp. {this.state.history.INCOME_TODAY}</Text>
                        <Text style={{ color: '#bbb', marginTop: 10 }}>{yesterday} % Yesterday</Text>
                    </View>
                    <View style={styles.incomeArea1}>
                        <Text style={{ color: '#cfbfe0', fontSize: 20, fontWeight: 'bold' }}>Orders</Text>
                        <Text style={{ color: '#ccc', marginTop: 10, fontSize: 18 }}>{this.state.history.order_week}</Text>
                        <Text style={{ color: '#bbb', marginTop: 10 }}>{order} % Last Week</Text>
                    </View>
                    <View style={styles.incomeArea1}>
                        <Text style={{ color: '#cfbfe0', fontSize: 20, fontWeight: 'bold' }}>This Year's Income</Text>
                        <Text style={{ color: '#ccc', marginTop: 10, fontSize: 18 }}>Rp. {this.state.history.year_omzet}</Text>
                        <Text style={{ color: '#bbb', marginTop: 10 }}>{year} % Last year</Text>
                    </View>
                </View>
                ...
                <View style={styles.historyArea}>
                    {
                        this.state.allhistory.map(data => {
                            return (
                                <DataHistory key={data.faktur} data={data} />
                            )
                        })
                    }
                </View>
